...
public class Customer_Bus_Profile extends AppCompatActivity {

    Toolbar toolbar;
    TextView model,plate_bus,driver_id,driver_fullname ;
    Button mBook, timetable,view_driver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBook = findViewById(R.id.add_route);
        mBook.setText("Book");
                ...
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if(driver.getBus_plate_number().equals(busBusPlate)){
                        ...
                        mBook.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent routeIntent = new Intent(getApplicationContext(),BusSeat.class);
                                ...
                                String bus_timetable_id = intentdata.getStringExtra("BusTime");
                                String bus_number_of_seat = intentdata.getStringExtra("BusNumberSeat");
                                String usernameCus = intentdata.getStringExtra("Cususername");
                                ...
                                routeIntent.putExtra("Cususername",usernameCus);
    ...
    public void adminEditAdminDataReturner(){
        Intent profile_intent = new Intent(Customer_Bus_Profile.this,EditAdminProfile.class);
    ...
    public void adminProfileDataReturner(){
        Intent profile_intent = new Intent(Customer_Bus_Profile.this,AdminProfile.class);
    ...
    public void adminBusDataReturner(){
        Intent admin_Driver_intent = new Intent(Customer_Bus_Profile.this,AdminBus.class);
        Administration admin = new Administration();
        Intent intent = getIntent();
        String name = intent.getStringExtra("Adfullname");
        String id = intent.getStringExtra("Adid");
    ...
    public void adminEditDriverDataReturner(){
        Intent profile_intent = new Intent(Customer_Bus_Profile.this,EditDriverProfile.class);
