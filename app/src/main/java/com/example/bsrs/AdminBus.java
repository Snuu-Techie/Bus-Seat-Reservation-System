...
public class AdminBus extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    DrawerLayout drawer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addDrivers.setText("Add Bus");
        addDrivers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent addDrivers = new Intent(AdminBus.this,AddBuses.class);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent logoutIntent = new Intent(AdminBus.this,Login.class);
    ...
    public void adminSettingsDataReturner(){
        Intent profile_intent = new Intent(AdminBus.this,Settings.class);
    ...
    public void adminHomeDataReturner(){
        Intent profile_intent = new Intent(AdminBus.this,AdminDashboard.class);
        Administration admin = new Administration();
        Intent intent = getIntent();
        String name = intent.getStringExtra("Adfullname");
        String id = intent.getStringExtra("Adid");
        ...
        final ValueEventListener valueEventListener = new ValueEventListener(){
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    mylayout = new LinearLayoutManager(AdminBus.this);
   ...
   /* public void driverArray(){
    ...
    public void adminProfileDataReturner(){
        Intent profile_intent = new Intent(AdminBus.this,AdminProfile.class);
        Administration admin = new Administration();
        Intent intent = getIntent();
        String name = intent.getStringExtra("Adfullname");
        String id = intent.getStringExtra("Adid");
