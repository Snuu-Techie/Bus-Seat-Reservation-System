...
public class CustomerDrivers extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    DrawerLayout drawer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent logoutIntent = new Intent(CustomerDrivers.this,Login.class);
    ...
    public void adminSettingsDataReturner(){
        Intent profile_intent = new Intent(CustomerDrivers.this,Settings.class);
    ...
    public void adminHomeDataReturner(){
        Intent profile_intent = new Intent(CustomerDrivers.this,AdminDashboard.class);
        Administration admin = new Administration();
        Intent intent = getIntent();
        String name = intent.getStringExtra("Adfullname");
        String id = intent.getStringExtra("Adid");
    ...
    public void adminCustomerDataReturner(){
        Intent profile_intent = new Intent(CustomerDrivers.this,AdminCustomer.class);
        Administration admin = new Administration();
        Intent intent = getIntent();
        String name = intent.getStringExtra("Adfullname");
        String id = intent.getStringExtra("Adid");
    ...
    public void adminBusDataReturner(){
        Intent profile_intent = new Intent(CustomerDrivers.this,AdminBus.class);
        Administration admin = new Administration();
        Intent intent = getIntent();
        String name = intent.getStringExtra("Adfullname");
        String id = intent.getStringExtra("Adid");
        ...
        final ValueEventListener valueEventListener = new ValueEventListener(){
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    mylayout = new LinearLayoutManager(CustomerDrivers.this);
   ...
   /* public void driverArray(){
    ...
    public void adminProfileDataReturner(){
        Intent profile_intent = new Intent(CustomerDrivers.this,AdminProfile.class);
        Administration admin = new Administration();
        Intent intent = getIntent();
        String name = intent.getStringExtra("Adfullname");
        String id = intent.getStringExtra("Adid");
    ...
    public void myDriver(){
        Intent my_Bus_Intent = new Intent(CustomerDrivers.this,My_Driver.class);
