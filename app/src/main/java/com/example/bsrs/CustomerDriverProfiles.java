...
public class CustomerDriverProfiles extends AppCompatActivity {
    ...
    public void adminEditAdminDataReturner(){
        Intent profile_intent = new Intent(CustomerDriverProfiles.this,EditAdminProfile.class);
    ...
    public void adminProfileDataReturner(){
        Intent profile_intent = new Intent(CustomerDriverProfiles.this,AdminProfile.class);
    ...
    public void adminDriverDataReturner(){
        Intent admin_Driver_intent = new Intent(CustomerDriverProfiles.this,AdminDriver.class);
        Administration admin = new Administration();
        Intent intent = getIntent();
        String name = intent.getStringExtra("Adfullname");
        String id = intent.getStringExtra("Adid");
    ...
    public void adminEditDriverDataReturner(){
        Intent profile_intent = new Intent(CustomerDriverProfiles.this,EditDriverProfile.class);
