...
public class Bus_DriverProfile extends AppCompatActivity {
    ...
    public void adminEditAdminDataReturner(){
        Intent profile_intent = new Intent(Bus_DriverProfile.this,EditAdminProfile.class);
    ...
    public void adminProfileDataReturner(){
        Intent profile_intent = new Intent(Bus_DriverProfile.this,AdminProfile.class);
    ...
    public void adminDriverDataReturner(){
        Intent admin_Driver_intent = new Intent(Bus_DriverProfile.this,BusProfile.class);
        Administration admin = new Administration();
        Intent intent = getIntent();
        String name = intent.getStringExtra("Adfullname");
        String id = intent.getStringExtra("Adid");
        ...
        admin_Driver_intent.putExtra("BusSeat_id", bus_seat_id);
        admin_Driver_intent.putExtra("BusNumberSeat", bus_number_of_seat);
        admin_Driver_intent.putExtra("BusModel", bus_model);
        admin_Driver_intent.putExtra("BusRoute", bus_route_id);
        admin_Driver_intent.putExtra("BusBusPlate", bus_plate);
        admin_Driver_intent.putExtra("BusTime", bus_timetable_id);
    ...
    public void adminEditDriverDataReturner(){
        Intent profile_intent = new Intent(Bus_DriverProfile.this,EditDriverProfile.class);
