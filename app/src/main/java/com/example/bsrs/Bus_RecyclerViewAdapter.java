...
public class Bus_RecyclerViewAdapter extends RecyclerView.Adapter<Bus_RecyclerViewAdapter.AdminBusViewHolder> implements Filterable {
    List<Bus> buses;
    List<Bus> busesFull;
    private OnItemClickListener admin_bus_ItemListener;
    private Context context;
    public interface OnItemClickListener{
        void  onItemClick(int postion);
    }
    public void setOnitemClickListener(OnItemClickListener listener){
        admin_bus_ItemListener = listener;
    }


    public static  class AdminBusViewHolder extends RecyclerView.ViewHolder{

        private TextView plate,model,number_of_seats;
        private CardView cardView;

        public AdminBusViewHolder(@NonNull View itemView,final OnItemClickListener listener) {
            super(itemView);
    ...
    public Bus_RecyclerViewAdapter(ArrayList<Bus> driver){
        buses = driver;
    ...
    @NonNull
    @Override
    public AdminBusViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.buses_activity,parent,false);
        AdminBusViewHolder holder = new AdminBusViewHolder(view,admin_bus_ItemListener);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdminBusViewHolder holder, int position) {
